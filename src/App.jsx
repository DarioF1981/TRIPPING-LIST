...
function ProfileSelector({ onSelect, onClose }) {
  ...
  if (step === 1) return (
    <div style={{ position:"fixed", inset:0, background:"#0F172A", zIndex:300,
      ...
      <div style={{ padding:"14px 16px calc(50px + env(safe-area-inset-bottom, 50px))" }}>
        <button onClick={onClose} style={{ width:"100%", background:"#334155", border:"none",
  ...
  return (
    <div style={{ position:"fixed", inset:0, background:"#0F172A", zIndex:300,
      ...
      <div style={{ padding:"14px 16px calc(50px + env(safe-area-inset-bottom, 50px))", background:"#0F172A", borderTop:"1px solid #1E293B" }}>
...
function GestioneLista({ catMap, catNames, customItems, removedIds, expiry, onSave, onClose, onImport }) {
  ...
  return (
    <div style={{ fontFamily:"'Segoe UI',system-ui,sans-serif", background:"#0F172A", minHeight:"100vh", color:"#F1F5F9", paddingBottom:200 }}>
      ...
      <div style={{ position:"fixed", bottom:0, left:0, right:0, padding:"14px 16px calc(50px + env(safe-area-inset-bottom, 50px))", background:"#0F172A", borderTop:"1px solid #1E293B" }}>
        <div style={{ display:"flex", gap:10 }}>
    ...
    return <GestioneLista
      ...
      onImport={() => {
        ...
        try {
          ...
          setHiddenGroups([]);
          localStorage.setItem("cv_hidden_v4", "[]");
